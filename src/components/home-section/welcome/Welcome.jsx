...
const champImgs = [champSoldado, champGenji, champSombra];
    ...
    >
      <div className="welcome__info relative">
        <div className="welcome__info__content">
          <div className="title">
            <span>Sua luta começa agora!</span>
            <h2 className="main-color">OVERWATCH</h2>
          </div>
          <div className="description m-t-4">
            É hora de reencontrar e lutar ao lado dos outros heróis. Convidamos
            você a viajar pelo mundo e curtir novas formas sensacionais de jogar
            enquanto luta no campo de batalha. Caia na ação, libere o seu poder
            e saia na vanguarda da história de Overwatch. Vale a pena lutar pelo
            futuro — você vai entrar no combate?
          </div>
          <div className="btns m-t-4">
            <Button className="btn-main">JOGUE AGORA</Button>
            <Button className="btn-second">COMPRE JA</Button>
          </div>
        </div>
      </div>
